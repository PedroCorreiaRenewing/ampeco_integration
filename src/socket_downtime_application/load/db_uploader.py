...
class DBUploader:
    ...
    def upsert_socket_downtime(self,socket_downtime_df):
        self.interactor.upsert_dataframe("socket_downtime", socket_downtime_df, conflict_columns=["source_id", "source_system_id"])
